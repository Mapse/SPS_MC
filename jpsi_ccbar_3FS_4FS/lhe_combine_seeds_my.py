...
if __name__ == '__main__':
    ...
    # Model for the paths
    job_paths = '/eos/user/m/mabarros/Monte_Carlo/SPS/SPS_MC/jpsi_ccbar_3FS_4FS/condor_jobs_organized/'    
    ...
    #print(f'Calculating average cross section and doing reweighting.. Grab a coffee :)')
