...
## Path to gs frameng
path_gs=Configuration/GenProduction/python/Jpsi_30to50_Dstar_SPS_13TeV_GS_cfi.py

# Path to lhe file produce with Helac-Onia
#path_lhe=/afs/cern.ch/work/m/mabarros/public/MonteCarlo/SPS/CMSSW_10_6_20_patch1/src/HelacOnia_lhe/3fs_4fs/Jpsi_30to50_Dstar_file_0.lhe
path_lhe=/afs/cern.ch/work/m/mabarros/public/MonteCarlo/SPS/CMSSW_10_6_20_patch1/src/HelacOnia_lhe/vfns/Jpsi_30to50_Dstar_vfns_file_0.lhe

# lhe file out
py_lhe=Jpsi_30to50_Dstar_SPS_2016pos_13TeV_LHE_cfg.py

# Number of events for gs step
nevt=-1

# GS cfg fragment 
py_gs=Jpsi_30to50_Dstar_SPS_2016pos_13TeV_GS_cfg.py

# For MC Gen parameters 
REPORT_NAME=Jpsi_30to50_Dstar_SPS_2016pos_13TeV_report.xml

## Root files

# GS root
root_gs=Jpsi_30to50_Dstar_SPS_2016pos_13TeV_GS.root

# LHE root
root_lhe=Jpsi_30to50_Dstar_SPS_2016pos_13TeV_LHE.root
