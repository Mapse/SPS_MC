...
REPORT_NAME=Jpsi_9to30_Dstar_SPS_2017_13TeV_report.xml
...
cmsDriver.py $path_gs --fileout file:$root_gs --mc --eventcontent RAWSIM --datatier GEN --conditions 106X_mc2017_realistic_v8 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN --customise Configuration/DataProcessing/Utils.addMonitoring --geometry DB:Extended --era Run2_2017 --filein file:$root_lhe --python_filename $py_gs -n $nevt --no_exec
