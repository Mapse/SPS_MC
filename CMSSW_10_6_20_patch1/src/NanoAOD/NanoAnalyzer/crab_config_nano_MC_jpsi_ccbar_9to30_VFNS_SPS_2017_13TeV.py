...
## Config
config = config()
config.General.requestName = 'NANO_MC_jpsi_ccbar_9to30_VFNS_SPS_2017_13TeV_22-08-2023'
...
config.Data.outputDatasetTag = 'jpsi_ccbar_9to30_VFNS_SPS_2017_13TeV'
config.Data.userInputFiles = open('paths/jpsi_ccbar_9to30_VFNS_SPS_2017_13TeV.txt').readlines()
